...
#' Default) use colors from \code{data4PCCAR::tepPLS}.
#' @param col4J
#' a color vector for
...
graph4tepPLS <- function(
    ...
    resPCA <- nameExpositionResults(data4PCCAR::tepPLS(DATA = data,
                                                       center = center,
                                                       scale = scale,
                                                       DESIGN = DESIGN,
