# Work file for CCA output ----
# Created  07/15/2022
# for package R4SPISE2022
# Current Version 07/15/2022
# Goal: generates standard graphs and tables for CCA
# Author Hervé
# Entête -----
# install.packages('sinew')
# sinew::makeOxygen(graph4tepCCA)
# Preamble ----
# Pass Results from Exposition
# ExPosition
#
# Documentation -----
#' @title graph4tepCCA run a CCA
#' (with the \code{tepCCA} function)
#' and generates the standard graphs and tables.
#' Note: *Still Under Development*.
#' @description \code{graph4tepCCA}
#' graph4tepCCA run a principal component
#' analysis
#' (with the \code{tepCCA} function)
#' and generates the standard graphs and tables.
...
#' Default) use colors from \code{data4PCCAR::tepCCA}.
#' @param col4J
#' a color vector for
...
# function ----
graph4tepCCA <- function(
        resCCA, # res from tepCCA
  ...
  title4pptx = "CCA Results" # title of pptx
){
...
resPCA <- nameExpositionResults(data4PCCAR::tepCCA(DATA = data,
                            center = center,
                            scale = scale,
                            DESIGN = DESIGN,
