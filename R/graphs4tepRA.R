# Work file for RA output ----
# Created  07/15/2022
# for package R4SPISE2022
# Current Version 07/15/2022
# Goal: generates standard graphs and tables for RA
# Author Hervé
# Entête -----
# install.packages('sinew')
# sinew::makeOxygen(graph4tepRA)
# Preamble ----
# Pass Results from Exposition
# ExPosition
#
# Documentation -----
#' @title graph4tepRA run a RA
#' (with the \code{tepRA} function)
#' and generates the standard graphs and tables.
#' Note: *Still Under Development*.
#' @description \code{graph4tepRA}
#' graph4tepRA run a principal component
#' analysis
#' (with the \code{tepRA} function)
#' and generates the standard graphs and tables.
...
#' Default) use colors from \code{data4PCCAR::tepRA}.
#' @param col4J
#' a color vector for
...
# function ----
graph4tepRA <- function(
        resRA, # res from tepRA
        ...
        title4pptx = "RA Results" # title of pptx
){
    ...
    resPCA <- nameExpositionResults(data4PCCAR::tepRA(DATA = data,
                                                       center = center,
                                                       scale = scale,
                                                       DESIGN = DESIGN,
