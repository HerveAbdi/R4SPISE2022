...
The bootstrap test identifies three significant dimensions that have eigenvalues reliably larger than 0. The permutation test identifies one significant dimension with an eigenvalue significantly larger than 0.
