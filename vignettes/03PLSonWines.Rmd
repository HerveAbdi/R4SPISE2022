...
The scree plot shows the eigenvalues of each dimension. 

_Note_: When the variables are centered and scale to have their _standard deviations_ equals 1, the values of these eigenvalues equal the squared correlation ($R^2$) of each pair of latent variables. In other words, the singular values, which are the square root of the eigenvalues, give the correlation of these pairs of latent variables. 
