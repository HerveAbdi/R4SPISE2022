...
vignette: >
  %\VignetteIndexEntry{PLSR on Wines (Part 1)}
...
```{r run, results = FALSE}
res.plsr <- data4PCCAR::PLSR_SVD(chemi, hedo, 3, inference = TRUE, displayJack = FALSE)
```
...
```{r PLSR plots, fig.show='hide', message = FALSE, warning = FALSE}
...
```{r corcircles}
res.plsr.plot$results.graphs$cirCorX.plot
